...
<body class="bg-gray-100">
    <div class="min-h-screen flex">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
            ...
            <nav>
                <a href="{{ route('waiter.dashboard') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white bg-gray-700">
                    <i class="fas fa-chart-bar mr-2"></i>Dashboard
                </a>
                <a href="{{ route('waiter.orders.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="fas fa-shopping-cart mr-2"></i>Pesanan
                </a>
                <a href="{{ route('waiter.tables.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="fas fa-chair mr-2"></i>Meja
                </a>
                <a href="{{ route('waiter.reservations.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
            ...
            <div class="absolute bottom-0 w-full">
                <div class="px-4 py-2 border-t border-gray-700">
                    <div class="flex items-center space-x-2 mb-2">
                        ...
                        <span class="text-sm">Test User</span>
                    </div>
